...
import { ArrowCircleRightIcon, CheckCircleIcon } from "@heroicons/vue/outline";
// components
import TheTitle from "@/components/TheTitle.vue";
import { TitleNCAA } from "@/composables/titlesState";
defineProps({
  activeTab: Boolean,
});
